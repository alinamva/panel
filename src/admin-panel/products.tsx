...
const Products = ({ productData }: ProductsProps) => {
  ...
  return (
    <div className="flex flex-col w-full h-dvh bg-lightGrey text-midnightBlue ">
      ...
      <div className="flex flex-col gap-10 p-10">
        <div className="grid justify-between grid-cols-4 gap-10">
          <div className="flex items-center justify-center w-full gap-3 bg-white h-28 rounded-xl">
            <div className="p-3 rounded-full bg-lightBlue">
          ...
          <div className="flex items-center justify-center w-full gap-3 bg-white h-28 rounded-xl">
            <div className="p-3 rounded-full bg-lightRed">
          ...
          <div className="flex items-center justify-center w-full gap-3 bg-white h-28 rounded-xl">
            <div className="p-3 rounded-full bg-lightOrange">
              <svg width="24" height="24" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
          ...
          <div className="flex items-center justify-center w-full gap-3 bg-white h-28 rounded-xl">
            <div className="p-3 rounded-full bg-lightGreen">
              <svg width="24" height="24" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        {isAddOpen && <Addform setIsAddOpen={setIsAddOpen} storedData={storedData} allData={storedData} />}

        <ProductsDataTable allData={storedData} />
      </div>
    </div>
  );
};
